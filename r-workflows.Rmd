...
Before we enter any code into our script, it is good practice to fill the first few lines with text comments which indicate the script's title, author, and creation or last edit date. We can create a comment in a script by typing `#` before the text. An example is given below.
