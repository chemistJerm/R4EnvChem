...
hi
```
Again, you don't need to worry too much about these until Section 2, but if you are interested in learning more about more advanced data structures, you can check out the  [*Data structure*](http://adv-r.had.co.nz/Data-structures.html) chapter of *Advanced R* by Hadley Wickham.
