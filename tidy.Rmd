...
`pivot_longer` has many other features that you can take advantage of. We highly recommend reading the examples listed on the [data pivoting](https://tidyr.tidyverse.org/articles/pivot.html) reference page to get a better sense of the possibilities. 
...
For more examples on how to use this feature of `pivot_longer()`, check out the [data pivoting ](https://tidyr.tidyverse.org/articles/pivot.html#many-variables-in-column-names) reference page.
