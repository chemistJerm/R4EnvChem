...
## Blank RStudio projects

When you want to create a new RStudio project from scratch (e.g. for a lab report): go to *File*->*New Project*, or click the button highlighted in the image below. Click *New Directory*, then *New Project*. 
