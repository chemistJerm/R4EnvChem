...
This section will teach you **how** to use R to meet your data analysis needs using a common workflow. If you want to know more about the theory (the **why**) behind these steps, check out Section 3. 

Whether it takes 10 minutes or 10 hrs, *you'll use this workflow for every data analysis project*. By understanding the workflow steps and how to execute them in R, you'll be more than capable of applying the limited tools learned from this book to any data analysis project.
...
Throughout this section and the next we'll be making use of a couple of example datasets. These datasets are all availabe in the `data` subfolder of the *R4EnvChem Project Template*. If you haven't already, you can download them from the repository [here](https://github.com/DavidRossHall/R4EnvChem-ProjectTemplate)
